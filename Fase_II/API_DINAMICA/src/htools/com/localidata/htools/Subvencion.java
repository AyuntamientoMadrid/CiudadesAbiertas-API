...
public class Subvencion implements java.io.Serializable {
    ...
    public Subvencion(String ikey, String id, String title, String areaId, String areaTitle, String municipioId, String municipioTitle, String adjudicatarioId, String adjudicatarioTitle, String entidadFinanciadoraId,
	    String entidadFinanciadoraTitle, BigDecimal importe, Date fechaAdjudicacion, String lineaFinanciacion, String basesReguladoras, String tipoInstrumento, String aplicacionPresupuestaria) {
	this.ikey = ikey;
	this.id = id;
	this.title = title;
	this.areaId = areaId;
