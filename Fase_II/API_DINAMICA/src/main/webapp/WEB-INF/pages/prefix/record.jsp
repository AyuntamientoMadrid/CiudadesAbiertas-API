...
<body>
	...
	<div class="form_steps">
		<ul>
		  ...
		  <li class="active" id="4"><a href="<c:url value="/prefix"/>">4. <span>Listado</span></a></li>	
		  <li class="selected" id="5">5. <span>Ficha</span></li>
		</ul>
	</div>
		...
		<div class="brand">
			<div class="row">
				...
				<div class="col-9 options">
					<ul>
						<li>
							<a title="Editar" href="<c:url value="/prefix/edit/${object.id}"/>" id="enlaceEditar"><i class="ico icon-exchange"></i><span class="text">Editar</span></a>
						</li>
						<li>
							<a title="Eliminar" href="<c:url value="/prefix/delete/${object.id}"/>" id="enlaceBorrar"/><i class="ico icon-close"></i><span class="text">Eliminar</span></a>
						</li>						
						<li class="font_size">
...
<div class="row bloque1">
	<div class="col-xs-12 col-md-12 col-lg-10 col-xl-10">
	    <jsp:include page="../includes/prefix/readOnly.jsp" />
	</div>
</div>	
