...
<body>
	...
	<div class="form_steps">
		<ul>
		  ...
		  <li class="selected" id="5"><a href="<c:url value="/semanticDef/${object.code}"/>">5. <span>Ficha</span></a></li>
...
<div class="row bloque1">
	<div class="col-xs-12 col-md-12 col-lg-10 col-xl-10">
		<div class="form">	  
			<jsp:include page="../includes/semantic/form.jsp" >
...
<div class="scroll_button_bottom">
	...
	<script src="<c:url value="/resources/js/semantic/commons.js"/>"></script>

<script>

var htmlParamCode="";
var numParams=$("[id^=capaParametro]").length;
var buttonAddParaCode="<div class='row buttons' id='addParam0'>"+$("#addParam0").html()+"</div>";
...
$(document).ready(function()
		{				 
			...
			htmlParamCode=$("#capaParametro0").html();			
			htmlParamCode="<div id='capaParametro0'>"+htmlParamCode+"</div>";
