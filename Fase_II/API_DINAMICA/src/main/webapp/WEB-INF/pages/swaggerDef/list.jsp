...
<c:set var="title" value="<%=LiteralConstants.TITLE_HEAD_SWAGGER_DEF%>" scope="session"/>
<!DOCTYPE html>
<html lang="es">
...
<body>
	...
	<div class="user_name">
   	...
   	<div class="title mt-0">
		<div class="container">
			<div class="col-md-12">
				<p id="parrafoTitulo">Listado Definiciones de Swagger</p>
			</div>
		</div>
	</div>
		...
		<div class="brand">
			<div class="row">
				...
				<div class="col-9 options">
					<ul>
						<li>
							<a title="Añadir" href="<c:url value="/swaggerDef/add"/>"><i class="ico icon-add"></i><span class="text">Añadir</span></a>
						</li>						
						<li class="font_size">
				...
				<c:forEach var="entidad" items="${list}" varStatus="loop">   
					...
					<c:choose>
					  ...
					  <c:otherwise>
			            ...
			            <h4 id="title_element_${loop.count}"><a href="<c:url value="/swaggerDef/${entidad.code}"/>"><c:out value="${entidad.code}" /></a></h4>
			            <p><c:out value="${entidad.description}" /></p>
			        </li>
			     </c:forEach>   
			</ul>
		</div>
