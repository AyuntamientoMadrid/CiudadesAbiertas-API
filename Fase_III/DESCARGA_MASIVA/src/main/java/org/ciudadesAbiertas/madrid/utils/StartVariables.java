...
public class StartVariables
{
    ...
    // Mapa donde se encuentran todas las clases con sus columnas en java y columnas
    // en tabla
    public static Map<String, Map<String, String>> mapaClasesColumnas;

    // parametro para la configuración de las coordenadas geograficas valor por
    // defecto (25830)
    ...
    public static MappingJackson2XmlHttpMessageConverter xmlConverter;
