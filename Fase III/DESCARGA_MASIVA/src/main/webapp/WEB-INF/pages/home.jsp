	...
	<div class="bg_greysoft">
		<div class="row bloque1">
			<div class="col-xs-12 col-md-12 col-lg-12 col-xl-12">
				<div class="tiny-text">
					<p>Bienvenid@ a la aplicación Descarga Masiva. </p>
				...
				<fieldset>
					<div class="form-row">
						<div class="form-group col-md-3">
							<label class="control-label bold">Consultas SQL</label>
							<p>${numQueries}</p>
						</div>
						<div class="form-group col-md-3">
							<label class="control-label bold">Consulta más utilizada</label>
							<p>${urlMostWanted}</p>
						</div>
						<div class="form-group col-md-3 ">
							<label class="control-label bold">Última tarea</label>
							<p>${lastPetition}</p>
						</div>
						<div class="form-group col-md-3 ">
							<label class="control-label bold">Tareas en los ultimos 7 días</label>
