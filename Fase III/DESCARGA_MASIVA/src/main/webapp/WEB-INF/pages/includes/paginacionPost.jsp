		            ...
		            <nav aria-label="Page navigation example">
		                <ul class="pagination justify-content-center justify-content-md-end">
		                	<c:if test="${not empty first}">
			                	<li class="page-item">
				                        <a class="page-link" href="javascript:paginacionPost('<c:url value="${first}"/>')" aria-label="First">
		                	...
		                	<c:if test="${not empty prev}">
			                    <li class="page-item">
			                        <a class="page-link" href="javascript:paginacionPost('<c:url value="${prev}"/>')" aria-label="Previous">
		                    ...
		                    <c:if test="${not empty next}">
			                    <li class="page-item">
			                        <a class="page-link" href="javascript:paginacionPost('<c:url value="${next}"/>')" aria-label="Next">
		                    ...
		                    <c:if test="${not empty last}">
		                    	<li class="page-item">
			                        <a class="page-link" href="javascript:paginacionPost('<c:url value="${last}"/>')" aria-label="Last">
...
<script>
function paginacionPost(dir)
{
	var formulario='${param.formulario}';
	console.log(dir);
	urlParams = new URLSearchParams(dir);
