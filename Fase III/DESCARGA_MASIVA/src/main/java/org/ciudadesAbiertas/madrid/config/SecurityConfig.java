...
import org.ciudadesAbiertas.madrid.controller.dynamic.ProcessController;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	*/
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		roleUserURLs.add(ProcessController.path+"**");
		roleUserURLs.add(QueryController.PATH+"**");
		roleUserURLs.add(TaskController.PATH+"**");
