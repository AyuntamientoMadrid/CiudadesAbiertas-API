...
public class Constants {
    ...
    public static List<Integer> minute = new ArrayList<Integer>();
    public static List<Integer> hour = new ArrayList<Integer>();
    public static Map<Integer,String> dayW = new TreeMap<Integer,String>();
    public static List<Integer> dayM = new ArrayList<Integer>();
    public static Map<Integer,String> month = new TreeMap<Integer,String>();
