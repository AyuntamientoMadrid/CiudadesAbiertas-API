 ...
 *
 */
public class EntidadBaseUtilTest
{
	...
	{		
		EntidadBase copia=new EntidadBase(bean);
		
		assertTrue(copia.equals(bean));
	}
	
	@Test
	public void equalsTest() throws JsonParseException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException
	{
		
		EntidadBase copia=new EntidadBase(bean);
		
		boolean allFields = TestUtils.checkAllAttributes(copia, new String[0]);
