...
<body>
	...
	<div class="user_name">
   	...
   	<div class="title mt-0">
		<div class="container">
			<div class="col-md-12">
				<p id="parrafoTitulo">${object.texto}</p>
			</div>
		</div>
	</div>
		...
		<div class="brand">
			<div class="row">
				...
				<div class="col-9 options">
					<ul>
						<li>
							<a title="Editar" href="<c:url value="/entidadBase/edit/${object.id}"/>" id="enlaceEditar"><i class="ico icon-exchange"></i><span class="text">Editar</span></a>
						</li>
						<li>
							<a title="Eliminar" href="<c:url value="/entidadBase/delete/${object.id}"/>" id="enlaceBorrar"/><i class="ico icon-close"></i><span class="text">Eliminar</span></a>
						</li>						
						<li class="font_size">
...
<div class="row bloque1">
	<div class="col-xs-12 col-md-12 col-lg-10 col-xl-10">
	    <jsp:include page="../includes/entidadBase/readOnly.jsp" />
	</div>
</div>	
