...
<body>
	...
	<div class="form_steps">
		<ul>
		  ...
		  <li class="done" id="2">2. <span>Definiciones de Swagger</span></li>
		  <li class="selected" id="3"><a href="<c:url value="/swaggerDef"/>">3. <span>Listado</span></a></li>		  
	...
	<div class="share_menu">
		<div class="brand">
			<div class="row">
				<div class="col-3">
					<a href="<c:url value="/swaggerDef"/>"><i class="ico icon-arrow-left"></i> Volver</a>
				</div>
				<div class="col-9 options">
					<ul>
						<li>
							<a title="Editar" href="<c:url value="/swaggerDef/edit/${object.code}"/>" id="enlaceEditar"><i class="ico icon-exchange"></i><span class="text">Editar</span></a>
						</li>
						<li>
							<a title="Eliminar" href="<c:url value="/swaggerDef/delete/${object.code}"/>" id="enlaceBorrar"/><i class="ico icon-close"></i><span class="text">Eliminar</span></a>
						</li>						
						<li class="font_size">
...
<div class="row bloque1">
	<div class="col-xs-12 col-md-12 col-lg-10 col-xl-10">
	    <jsp:include page="../includes/swaggerDef/readOnly.jsp" />
	</div>
</div>	
