...
<body>
	...
	<div class="user_name">
   	...
   	<div class="title mt-0">
		<div class="container">
			<div class="col-md-12">
				<p id="parrafoTitulo">Listado Definiciones Semánticas</p>
			</div>
		</div>
	</div>
	...
	<div class="form_steps">
		<ul>
		  ...
		  <li class="selected" id="4">4. <span>Listado</span></li>		  
		</ul>
	</div>
		...
		<div class="brand">
			<div class="row">
				...
				<div class="col-9 options">
					<ul>
						<li>
							<a title="Añadir" href="<c:url value="/semanticDef/add"/>"><i class="ico icon-add"></i><span class="text">Añadir</span></a>
						</li>						
						<li class="font_size">
	  ...
	  <c:otherwise>
	    ...
	    <div class="table-pagination">
	    	...
	    	<jsp:include page="../includes/paginacion.jsp" >
				<jsp:param name="texto" value="Definiciones Semánticas" />
			</jsp:include>	
		</div>
