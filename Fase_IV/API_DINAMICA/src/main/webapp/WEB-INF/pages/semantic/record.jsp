		...
		<div class="brand">
			<div class="row">
				...
				<div class="col-9 options">
					<ul>
						<li>
							<a title="Editar" href="<c:url value="/semanticDef/edit/${object.code}"/>" id="enlaceEditar"><i class="ico icon-exchange"></i><span class="text">Editar</span></a>
						</li>
						<li>
							<a title="Eliminar" href="<c:url value="/semanticDef/delete/${object.code}"/>" id="enlaceBorrar"/><i class="ico icon-close"></i><span class="text">Eliminar</span></a>
						</li>						
						<li class="font_size">
...
<div class="row bloque1">
	<div class="col-xs-12 col-md-12 col-lg-10 col-xl-10">
	    <jsp:include page="../includes/semantic/readOnly.jsp" />
	</div>
</div>	
