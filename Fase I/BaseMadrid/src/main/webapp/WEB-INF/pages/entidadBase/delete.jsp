...
<body>
	...
	<div class="form_steps">
		...
		<ul>
		  ...
		  <li class="selected" id="4"><a href="<c:url value="/entidadBase/${object.id}"/>">4. <span>Ficha</span></a></li>
...
<div class="row bloque1">	
	<div class="col-xs-12 col-md-12 col-lg-10 col-xl-10">
		...
		<div class="row buttons">
	        <div class="col-md-4">                
	          <a class="btn btn-secondary btn-block" href="<c:url value="/entidadBase/${object.id}"/>" role="button"  id="botonVolver">Volver</a>
	        </div>
	        <div class="col-md-4 offset-4">      
	        	  <form action="<c:url value='/entidadBase/delete/${object.id}' />" method='POST'>
